...
def parse_args():
    ...
    parser.add_argument("--epochs", type=int, default=10, help="快速测试用较少epochs")
    ...
    parser.add_argument(
        "--save",
        type=str,
        default="./logs_nodeembed/" + str(time.strftime("%Y-%m-%d-%H:%M:%S")) + "-",
        help="save path",
    )
