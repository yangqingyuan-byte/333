"""
训练脚本：训练 TimeCMA_BiCross 双向跨模态对齐模型
"""
import torch
...
from models.TimeCMA_BiCross import Dual_BiCross
...
def parse_args():
    ...
    parser.add_argument("--d_ff", type=int, default=32, help="FFN hidden dimensions")
    ...
    parser.add_argument(
        "--save",
        type=str,
        default="./logs_bicross/" + str(time.strftime("%Y-%m-%d-%H:%M:%S")) + "-",
        help="save path",
    )
